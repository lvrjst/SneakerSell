...
<%-- <div class="sidemenu clear-fix">
	<img class="clearfix" src="image/list_style_image.png" href="index.jsp">

	<h2><a href="sneakerSell.jsp#sneaker"><s:property value="item_id" /></a></h2>
	<ul>
		<li><a href="<s:url action='SneakerSellAction' />#jordan1"><s:property value="item_id" /></a></li>
		<li><a href="<s:url action='SneakerSellAction' />#jordan2">Air Jordan Ⅱ</a></li>
		<li><a href="<s:url action='SneakerSellAction' />#jordan3">Air Jordan Ⅲ</a></li>
		<li><a href="sneakerSell.jsp#jordan4">Air Jordan Ⅳ</a></li>
